...
function build(container)
{
  ...
  cfElement = document.createElement('span');
  cfElement.className = 'cf-build-status';
  cfElement.title = 'Cloudflare deployment status';
  cfElement.textContent = '● CF: deployed';

  container.append(statusButton, cfElement);
